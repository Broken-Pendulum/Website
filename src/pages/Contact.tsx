    ...
    return (
        <>
            ...
            <div className="relative flex grow overflow-hidden bg-fixed bg-gradient-to-b from-void to-exosphere items-center justify-center">
                ...
                <div className="z-10 w-full mx-[10%] text-center my-[5rem] [word-spacing:0.2rem] md:[word-spacing:0.8rem] font-main text-2xl tracking-wide border-dark-amethyst border-5 sm:border-8 md:border-10 bg-void/50 text-twilight p-5 text-lg sm:text-xl md:text-3xl">
